...
<div class="main_dj">
  ...
  <?php if(empty($status)): if(status == 2): ?><font color="#009AFF" size="5">升级失败，点此<a href="<?php echo U('User/upgrade',array('id'=>$id, 'status'=>1));?>">重新升级</a></font><?php else: ?>
      <form action="<?php echo U('User/upgradedeal',array('id'=>$id));?>" method="post" enctype="multipart/form-data">
  ...
  <div style="text-align:center;">
    <font color="#009AFF" size="5">升级授权审核中请耐心等候哦~.~</font>
  </div><?php endif; ?>
</div>
<div class="ps_img">
      <img src="#" />
