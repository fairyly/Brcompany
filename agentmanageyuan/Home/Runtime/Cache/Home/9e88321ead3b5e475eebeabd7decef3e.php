...
<html data-embedded="">
<head>
<title>直属代理订单-玲玲</title>
<meta http-equiv="X-UA-Compatible" content="IE=Edge,chrome=1">
<meta charset="utf-8" />
<meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
<meta name="description" content="为直属代理订单-玲玲提交数据。&lt;p&gt;微哥助理玲玲专属订单系统：由于手机问题导致提交失败，请联系对接人-微哥助理玲玲。&lt;/p&gt;">
...
body{
 ...
 .banner{
  ...
  line-height:45px;
      ...
      <div class="banner">
          <div class="banner-text">Tstar手机防护衣</div>
    </div>

<form class="center" data-form-token="9k1gYZ" data-validate-url="/f/9k1gYZ/validate_fields" id="new_entry" action="/f/9k1gYZ" accept-charset="UTF-8" method="post"><input type="hidden" name="utf8" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="xFlPS3vqGC5ig5+a19gW8bBJ9gsIxDurZfHV6JIIIb2dxncdyd3Ytksn0177d9iJf4+rNDs4Oe7vE7JB/S+M8g==" />

  <div class="form-header container-fluid" style="margin-top:46px;">
    <div class="row">
      <h1 class="form-title col-md-12">
        直属代理订单-玲玲
      </h1>
      <div class="form-description col-md-12"><p>微哥助理玲玲专属订单系统：由于手机问题导致提交失败，请联系对接人-微哥助理玲玲。</p></div>
    </div>
  </div>
    ...
    <div class="row">
        ...
        <div class="fields clearfix">
		   <div class="form-group" >
			  <p style="font-size:1.2em;"><i>请选择对接助理</i><!-- <span>选择级别</span> --></p>
        <select name="entry[field_11]" id="entry_field_11" class="needsclick" data-has-error="false">
          <option value="0">请选择</option><option selected="selected" value="C3VF">总代</option>
          <option value="s84r">Jim</option>
          <option value="ihwB">Jhon</option>
          <option value="G8Cv">Jack</option>
          <option value="G8Cv">Jay</option></select>
...
<div class="form-group" >
    <label class="field-label" onclick="" for="entry_field_3">
      收件人姓名
      
</label>
  <div class="field-content">

    <input type="text" value="" name="entry[field_3]" id="entry_field_3" />

  </div>
</div>


</div>            <div class="field field-mobile-field col-md-12 required" data-api-code="field_4" data-type="MobileField" data-label="收件人手机号" data-validations="[&quot;Presence&quot;,&quot;Format&quot;]">
              
<div class="form-group" >
    <label class="field-label" onclick="" for="entry_field_4">
      收件人手机号
  ...
  <input class="mobile-input input-with-icon" data-icon="gd-icon-mobile" type="tel" value="" name="entry[field_4]" id="entry_field_4" />
    <input value="true" type="hidden" name="entry[field_4_skip_verification]" id="entry_field_4_skip_verification" />
</div>
...
</div>            <div class="field field-text-field col-md-12 required" data-api-code="field_5" data-type="TextField" data-label="收件地址" data-validations="[&quot;Presence&quot;]">
              
<div class="form-group" >
    <label class="field-label" onclick="" for="entry_field_5">
      收件地址
      
</label>
  <div class="field-content">

    <input type="text" value="" name="entry[field_5]" id="entry_field_5" />

  </div>
</div>


</div>            <div class="field field-text-field col-md-12 required" data-api-code="field_8" data-type="TextField" data-label="授权代理商姓名" data-validations="[&quot;Presence&quot;]">
              
<div class="form-group" >
    <label class="field-label" onclick="" for="entry_field_8">
      授权代理商姓名
      
</label>
  <div class="field-content">
      <div class="field-description clearfix"><p>仅限总部直属代理商下单使用</p>
</div>
...
</div>            <div class="field field-drop-down col-md-12" data-api-code="field_11" data-type="DropDown" data-label="代理级别" data-validations="[]">
              
<div class="form-group" >
    <label class="field-label" onclick="" for="entry_field_11">
      代理级别
      
</label>
  <div class="field-content">
      <div class="field-description clearfix"><p>总代600盒，一级120盒，二级20盒，特约4盒</p>
</div>

    <select name="entry[field_11]" id="entry_field_11" class="needsclick" data-has-error="false"><option value="">请选择</option><option selected="selected" value="C3VF">总代</option>
<option value="s84r">一级</option>
<option value="ihwB">二级</option>
<option value="G8Cv">特约</option></select>
...
</div>            <div class="field field-text-field col-md-12" data-api-code="field_13" data-type="TextField" data-label="备注" data-validations="[]">
              
<div class="form-group" >
    <label class="field-label" onclick="" for="entry_field_13">
      备注
      
</label>
  <div class="field-content">
      <div class="field-description clearfix"><p>特殊情况请在此处填写，例如：快递</p>
</div>
...
</div>            <div class="field field-attachment-field col-md-12 required" data-api-code="field_9" data-type="AttachmentField" data-label="上传支付截图" data-validations="[&quot;Presence&quot;]">
...
</div>            <div class="field field-goods-field col-md-12" data-api-code="field_1" data-type="GoodsField" data-label="配货比例" data-validations="[]">
              
<div class="form-group" >
    <label class="field-label" onclick="" for="entry_field_1">
      配货比例
      
</label>
  <div class="field-content">
      <div class="field-description clearfix"><p>建议配货比例：总代200/200/160/40；一级40/40/30/10；二级7/7/4/2；特约/1/1/1/1</p>
</div>
...
<div class="price-number clearfix">
  ...
  <div class="number-container gd-input-prepend gd-input-append">
    ...
    <input type="number" name="entry[field_1][0][number]" id="entry_field_1_0_number" value="0" min="0" step="1" class="number" tabindex="-1" data-field-api-code="field_1" data-goods-value="5690a0f4a3f52023460000ef" data-goods-price="39.0" data-inventory="998780" />
...
<div class="price-number clearfix">
  ...
  <div class="number-container gd-input-prepend gd-input-append">
    ...
    <input type="number" name="entry[field_1][1][number]" id="entry_field_1_1_number" value="0" min="0" step="1" class="number" tabindex="-1" data-field-api-code="field_1" data-goods-value="5690a0f4a3f52023460000f0" data-goods-price="39.0" data-inventory="998650" />
    <a href="javascript:void(0)" class="add-on increase disabled">
      <i class="gd-icon-plus"></i>
    </a>
  </div>
...
<div class="price-number clearfix">
  ...
  <div class="number-container gd-input-prepend gd-input-append">
    ...
    <input type="number" name="entry[field_1][2][number]" id="entry_field_1_2_number" value="0" min="0" step="1" class="number" tabindex="-1" data-field-api-code="field_1" data-goods-value="5690a0f4a3f52023460000f1" data-goods-price="39.0" data-inventory="999860" />
    <a href="javascript:void(0)" class="add-on increase disabled">
      <i class="gd-icon-plus"></i>
    </a>
  </div>
...
<div class="price-number clearfix">
  ...
  <div class="number-container gd-input-prepend gd-input-append">
    ...
    <input type="number" name="entry[field_1][3][number]" id="entry_field_1_3_number" value="0" min="0" step="1" class="number" tabindex="-1" data-field-api-code="field_1" data-goods-value="5690a0f4a3f52023460000f2" data-goods-price="39.0" data-inventory="999970" />
    <a href="javascript:void(0)" class="add-on increase disabled">
      <i class="gd-icon-plus"></i>
    </a>
  </div>
