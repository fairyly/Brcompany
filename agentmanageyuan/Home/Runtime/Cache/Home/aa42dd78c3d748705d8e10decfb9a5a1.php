...
<title>代理商授权查询</title>
<script type="text/javascript" src="/agentmanageyuan/Public/javascripts/home/functions.js"></script>
<style type="text/css">
*{ margin:0; padding:0;}
p{ margin:0;}
a{ list-style:none;}
body{ font-family:'Microsoft YaHei'; font-size:12px; background:url(/agentmanageyuan/Public/images/home/chaxunbj.jpg) no-repeat; background-size:100%; color:#fff;}
...
<body>
<div class="header">
<p><img src="/agentmanageyuan/Public/images/home/chaoxunlogo_03.png"></p>
<form action="<?php echo U('Index/check');?>" method="post">
